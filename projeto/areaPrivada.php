...
// Gerar o texto estilizado
$styled_text = "";
for ($i = 0; $i < strlen($text); $i++) {
    $color = $colors[$i % count($colors)]; // Alterna entre as cores fornecidas
    $styled_text .= '<span style="color:' . $color . '; font-size:98px;">' . $text[$i] . '</span>';
}

// Imprimir o texto estilizado
echo '<h1 style="text-align: center;">' . $styled_text . '</h1>';
            }
            ?>
